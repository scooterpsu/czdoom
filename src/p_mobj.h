...
#define MF_SPECIAL      (unit_64t)(0x0000000000000001)
// Blocks.
#define MF_SOLID        (unit_64t)(0x0000000000000002)
// Can be hit.
#define MF_SHOOTABLE    (unit_64t)(0x0000000000000004)
// Don't use the sector links (invisible but touchable).
#define MF_NOSECTOR     (unit_64t)(0x0000000000000008)
// Don't use the blocklinks (inert but displayable)
#define MF_NOBLOCKMAP   (unit_64t)(0x0000000000000010)

// Not to be activated by sound, deaf monster.
#define MF_AMBUSH       (unit_64t)(0x0000000000000020)
// Will try to attack right back.
#define MF_JUSTHIT      (unit_64t)(0x0000000000000040)
// Will take at least one step before attacking.
#define MF_JUSTATTACKED (unit_64t)(0x0000000000000080)
// On level spawning (initial position),
//  hang from ceiling instead of stand on floor.
#define MF_SPAWNCEILING (unit_64t)(0x0000000000000100)
// Don't apply gravity (every tic),
//  that is, object will float, keeping current height
//  or changing it actively.
#define MF_NOGRAVITY    (unit_64t)(0x0000000000000200)

// Movement flags.
// This allows jumps from high places.
#define MF_DROPOFF      (unit_64t)(0x0000000000000400)
// For players, will pick up items.
#define MF_PICKUP       (unit_64t)(0x0000000000000800)
// Player cheat. ???
#define MF_NOCLIP       (unit_64t)(0x0000000000001000)
// Player: keep info about sliding along walls.
#define MF_SLIDE        (unit_64t)(0x0000000000002000)
// Allow moves to any height, no gravity.
// For active floaters, e.g. cacodemons, pain elementals.
#define MF_FLOAT        (unit_64t)(0x0000000000004000)
// Don't cross lines
//   ??? or look at heights on teleport.
#define MF_TELEPORT     (unit_64t)(0x0000000000008000)
// Don't hit same species, explode on block.
// Player missiles as well as fireballs of various kinds.
#define MF_MISSILE      (unit_64t)(0x0000000000010000)
// Dropped by a demon, not level spawned.
// E.g. ammo clips dropped by dying former humans.
#define MF_DROPPED      (unit_64t)(0x0000000000020000)
// Use fuzzy draw (shadow demons or spectres),
//  temporary player invisibility powerup.
#define MF_SHADOW       (unit_64t)(0x0000000000040000)
// Flag: don't bleed when shot (use puff),
//  barrels and shootable furniture shall not bleed.
#define MF_NOBLOOD      (unit_64t)(0x0000000000080000)
// Don't stop moving halfway off a step,
//  that is, have dead bodies slide down all the way.
#define MF_CORPSE       (unit_64t)(0x0000000000100000)
// Floating to a height for a move, ???
//  don't auto float to target's height.
#define MF_INFLOAT      (unit_64t)(0x0000000000200000)

// On kill, count this enemy object
//  towards intermission kill total.
// Happy gathering.
#define MF_COUNTKILL    (unit_64t)(0x0000000000400000)

// On picking up, count this item object
//  towards intermission item total.
#define MF_COUNTITEM    (unit_64t)(0x0000000000800000)

// Special handling: skull in flight.
// Neither a cacodemon nor a missile.
#define MF_SKULLFLY     (unit_64t)(0x0000000001000000)

// Don't spawn this object
//  in death match mode (e.g. key cards).
#define MF_NOTDMATCH    (unit_64t)(0x0000000002000000)

// Player sprites in multiplayer modes are modified
//  using an internal color lookup table for re-indexing.
// If 0x4 0x8 or 0xc,
//  use a translation table for player colormaps
#define MF_TRANSLATION  (unit_64t)(0x000000000c000000)
#define MF_TRANSLATION1 (unit_64t)(0x0000000004000000)
#define MF_TRANSLATION2 (unit_64t)(0x0000000008000000)
// Hmm ???.
#define MF_TRANSSHIFT 26

#define MF_UNUSED2      (unit_64t)(0x0000000010000000)
#define MF_UNUSED3      (unit_64t)(0x0000000020000000)

    // Translucent sprite?                                          // phares
#define MF_TRANSLUCENT  (unit_64t)(0x0000000040000000)

// this is free            LONGLONG(0x0000000100000000)

// these are greater than an int. That's why the flags below are now unit_64t
