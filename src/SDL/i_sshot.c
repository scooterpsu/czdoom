...
int I_ScreenShot (const char *fname)
{
  ...
  if (fp)
  {
    //png_struct *png_ptr = png_create_write_struct(PNG_LIBPNG_VER_STRING, png_error_ptr_NULL, error_fn, warning_fn);
    png_struct *png_ptr = png_create_write_struct(PNG_LIBPNG_VER_STRING, NULL, error_fn, warning_fn);
