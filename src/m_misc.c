...
default_t defaults[] =
{
  ...
  {"wadfile_3",{NULL,&wad_files[2]},{0,""},UL,UL,def_str,ss_none},
  {"wadfile_4",{NULL,&wad_files[3]},{0,""},UL,UL,def_str,ss_none},
  {"wadfile_5",{NULL,&wad_files[4]},{0,""},UL,UL,def_str,ss_none},
  {"wadfile_6",{NULL,&wad_files[5]},{0,""},UL,UL,def_str,ss_none},
  {"wadfile_7",{NULL,&wad_files[6]},{0,""},UL,UL,def_str,ss_none},
  {"wadfile_8",{NULL,&wad_files[7]},{0,""},UL,UL,def_str,ss_none},
  ...
  #endif
#else
  {"videomode",{NULL, &default_videomode},{0,"16"},UL,UL,def_str,ss_none},
#endif
  ...
  {"use_doublebuffer",{&use_doublebuffer},{0},0,1,             // proff 2001-7-4
...
// CPhipps - now they're the doom codes, so default.cfg can be portable
  ...
  {"key_menu_clear",  {&key_menu_clear},     {KEYD_ESCAPE}     ,
   0,MAX_KEY,def_key,ss_keys}, // key to clear a key binding
  {"key_strafeleft",  {&key_strafeleft},     {KEYD_TAB}           ,
   0,MAX_KEY,def_key,ss_keys}, // key to strafe left
  {"key_straferight", {&key_straferight},    {KEYD_BACKSPACE}           ,
  ...
  {"key_menu_backspace",{&key_menu_backspace},{KEYD_BACKSPACE} ,
   0,MAX_KEY,def_key,ss_keys}, // delete key in a menu
  {"key_menu_escape", {&key_menu_escape},    {32}    ,
   0,MAX_KEY,def_key,ss_keys}, // key to leave a menu      ,   // phares 3/7/98
  {"key_menu_enter",  {&key_menu_enter},     {13}     ,
   0,MAX_KEY,def_key,ss_keys}, // key to select from menu
  ...
  {"key_chatplayer4", {&destination_keys[3]}, {'r'}            ,
   0,MAX_KEY,def_key,ss_keys}, // key to chat with player 4
  {"key_weapontoggle",{&key_weapontoggle},    {'t'}            ,
   0,MAX_KEY,def_key,ss_keys}, // key to toggle between two most preferred weapons with ammo
